  ...
  return (
    <>
              ...
              {isAuthenticated ? (
                <>
                  ...
                  <div className="relative">
                    ...
                    {isSettingsMenuOpen && <div className="absolute right-0 top-full z-50 mt-2 w-56 rounded-xl border border-slate-200 bg-white p-2 text-sm shadow-lg">
      ...
      {isMobileMenuOpen && <div className="fixed inset-0 z-40 flex h-screen flex-col gap-5 overflow-y-auto bg-white px-6 pt-24 md:hidden">
        {isAuthenticated && <div className="flex items-center gap-4 border-b border-slate-100 pb-5"><NotificationBell /><Link href="/settings" onClick={closeMobileMenu} className="font-semibold text-slate-700">Settings</Link></div>}
